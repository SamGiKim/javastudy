...
public class CategoryControllorTest {
    @LocalServerPort
    private int port;
    ...
    public void CategoryTest() {
        ...
        ResponseEntity<CategoryDto> responseInsert = this.testRestTemplate.postForEntity(url +
        ...
        ResponseEntity<CategoryDto> responseInsert2 = this.testRestTemplate.postForEntity(url +
